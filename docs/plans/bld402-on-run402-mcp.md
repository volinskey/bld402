...
- [x] 1D-CLI.5: Bugs documented in `run402/docs/bug_reports/bld402-compat-bugs.md`. BUG-001 reproduced on Windows (SQL comment lines, not em-dash). BUG-004/005/007 fixed in bld402 agent instructions.
