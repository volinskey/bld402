-- =============================================================
-- Hangman — FROM template: templates/games/hangman/schema.sql
-- Template schema used EXACTLY as-is (including seed words)
-- =============================================================
...
-- Seed with default words (from template)
...
-- No demo modifications needed (per hangman-spec.md)
