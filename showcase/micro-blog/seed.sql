...
-- image_path stores the full storage key (bucket-prefixed) so the browser
-- can read it via GET /storage/v1/blob/<key> with no auth.
INSERT INTO posts (body, author_name, image_path, likes, is_seed, user_id) VALUES
  ...
  ('Just saw the most adorable dog', 'Sam', 'posts/seed-dog.jpg', 31, true, '00000000-0000-0000-0000-000000000000'),
  ('Today''s sunset was unreal', 'Ava', 'posts/seed-sunset.jpg', 19, true, '00000000-0000-0000-0000-000000000000'),
  ('Coffee > everything', 'Jordan', NULL, 15, true, '00000000-0000-0000-0000-000000000000'),
  ('Tried a new ramen place downtown', 'Kai', 'posts/seed-ramen.jpg', 22, true, '00000000-0000-0000-0000-000000000000'),
