-- =============================================================
-- Trivia Night — FROM template: templates/games/trivia-night/schema.sql
-- Template schema used EXACTLY as-is
-- =============================================================
...
-- Atomic score increment (from template)
...
-- =============================================================
-- Demo modifications (per trivia-night-spec.md)
-- =============================================================

-- Auto-cleanup: delete non-demo rooms older than 2 hours
